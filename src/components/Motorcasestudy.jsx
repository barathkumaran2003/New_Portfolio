        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
            ...
            <div className="flex items-center space-x-1 md:space-x-2 text-sm md:text-base text-white/50">
              ...
              <span className="text-white/90 truncate">Wilsonport</span>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="prose prose-invert max-w-none">
                ...
                Wilsonport is an Open-Source project which is a simple and clean multi-page portfolio website template for developers. I created this project for developers to quickly build a good-looking and fast-performing multi-page portfolio without having to code their portfolio from scratch.
        ...
        <div className="flex-grow">
          ...
          <div className="text-[10px] md:text-xs text-gray-400">Fitur Utama</div>
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                <a
                  href="https://github.com/barathkumaran2003/AVT"
                  target="_blank"
                  rel="noopener noreferrer"
